<template>
  ...
  <nav class="top-0 navbar navbar-expand-lg position-absolute z-index-3"
    ...
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3" :class="darkMode ? 'text-black' : 'text-white'"
        href="/">Vite Soft UI Dashboard PRO</a>
      ...
      <div id="navigation" class="pt-3 pb-2 collapse navbar-collapse w-100 py-lg-0">
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            ...
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-xl border-radius-xl mt-lg-3"
              ...
              <div class="d-lg-none">
                ...
                <router-link :to="{ name: 'Default' }" class="dropdown-item border-radius-md">Default</router-link>
                ...
                <router-link :to="{ name: 'VR Default' }" class="dropdown-item border-radius-md">Virtual
                  Reality</router-link>
            ...
            <div class="p-3 mt-0 dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl mt-lg-3"
                  ...
                  <div class="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image" :style="{
                    ...
                    <div
                      ...
                      <div class="icon icon-shape rounded-circle bg-white shadow text-center">
                        <i class="ni ni-diamond text-success text-gradient text-lg" aria-hidden="true"></i>
                      </div>
                  ...
                  <ul class="list-group">
                    ...
                    <li class="p-0 border-0 nav-item dropdown dropdown-hover dropdown-subitem list-group-item">
                      ...
                      <div class="px-2 py-3 mt-0 dropdown-menu" aria-labelledby="dropdownPasswordReset">
                        <router-link class="mb-1 dropdown-item ps-3 border-radius-md" :to="{ name: 'Reset Basic' }">
                          <span>Basic</span>
                        </router-link>
              ...
              <div class="d-lg-none">
                <div class="col-12 d-flex justify-content-center flex-column">
                  <h6 class="px-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Sign In</h6>
                  ...
                  <h6 class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Sign Up
                  </h6>
                  ...
                  <router-link :to="{ name: 'Signup Illustration' }"
                    class="dropdown-item border-radius-md">Illustration</router-link>
                  <h6 class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Reset
                    Password</h6>
                  <router-link :to="{ name: 'Reset Basic' }" class="dropdown-item border-radius-md">Basic</router-link>
                  ...
                  <h6 class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Lock</h6>
                  ...
                  <router-link :to="{ name: 'Lock Illustration' }"
                    class="dropdown-item border-radius-md">Illustration</router-link>
                  <h6 class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">2-Step
                    Verification</h6>
                  ...
                  <router-link :to="{ name: 'Verification Illustration' }"
                    class="dropdown-item border-radius-md">Illustration</router-link>
                  <h6 class="px-0 mt-3 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Error</h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md"
                      ...
                      <div class="d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Getting
                            Started</h6>
                          <span class="text-sm">
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md"
                      ...
                      <div class="d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Plugins
                          </h6>
                  ...
                  <li class="p-0 border-0 nav-item list-group-item">
                    <a class="py-2 dropdown-item ps-3 border-radius-md"
                      ...
                      <div class="d-flex">
                        ...
                        <div>
                          <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Utility
                            Classes</h6>
                          <span class="text-sm">
                ...
                <div class="col-md-12 g-0">
                  ...
                  <a class="py-2 dropdown-item ps-3 border-radius-md" href="../../pages/about-us.html">
                    <div class="d-flex">
                      ...
                      <div>
                        <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Foundation
                        </h6>
                        <span class="text-sm">See our colors, icons and typography</span>
                      </div>
                    </div>
                  ...
                  <a class="py-2 dropdown-item ps-3 border-radius-md" href="../../pages/about-us.html">
                    <div class="d-flex">
                      ...
                      <div>
                        <h6 class="p-0 dropdown-header text-dark font-weight-bolder d-flex align-items-center">Components
                        </h6>
                        <span class="text-sm">Explore our collection of fully designed components</span>
                      </div>
                    </div>
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="https://www.creative-tim.com/product/vite-soft-ui-dashboard-pro"
              class="mb-0 btn btn-sm btn-round me-1" :class="btnBackground ? btnBackground : 'bg-white'">Buy Now</a>
          </li>
        </ul>
      </div>
    </div>
