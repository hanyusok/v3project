        ...
        <li class="mb-2 border-0 list-group-item d-flex justify-content-between border-radius-lg"
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
              ...
              <span class="text-xs">{{ titleDesc }},
                <span class="font-weight-bold">{{ titleDesc2 }} </span></span>
            </div>
          </div>
          <div class="d-flex">
        ...
        <li class="mb-2 border-0 list-group-item d-flex justify-content-between border-radius-lg"
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
              ...
              <span class="text-xs">{{ title2Desc }},
                <span class="font-weight-bold">{{ title2Desc2 }}</span></span>
            </div>
          </div>
          <div class="d-flex">
            <button class="my-auto btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right">
        ...
        <li class="border-0 list-group-item d-flex justify-content-between border-radius-lg"
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
              ...
              <span class="text-xs">{{ title3Desc }},
                <span class="font-weight-bold">{{ title3Desc2 }}</span></span>
            </div>
          </div>
          <div class="d-flex">
            <button class="my-auto btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right">
