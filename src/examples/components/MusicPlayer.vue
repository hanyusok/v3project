<template>
  <div class="card card-background card-background-mask-dark align-items-start mt-4">
    <div class="full-background cursor-pointer" :style="{
    ...
    <div class="card-body">
      ...
      <div class="d-flex mt-4 pt-2">
        <vsud-button color="white" variant="outline" class="rounded-circle p-2 mb-0" type="button">
          <i class="fas p-2" :class="basic.isRTL ? 'fa-forward' : 'fa-backward'"></i>
        </vsud-button>
        <vsud-button color="white" variant="outline" class="rounded-circle p-2 mx-2 mb-0" type="button">
          <i class="fas fa-play p-2"></i>
        </vsud-button>
        <vsud-button color="white" variant="outline" class="rounded-circle p-2 mb-0" type="button">
          <i class="fas fa-forward p-2" :class="basic.isRTL ? 'fa-backward' : 'fa-forward'"></i>
        </vsud-button>
      </div>
    </div>
  </div>
