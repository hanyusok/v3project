        ...
        <div class="card z-index-0">
          ...
          <div class="card-body">
            <form role="form" class="text-start">
              <div class="mb-3">
                <vsud-input id="email" type="email" placeholder="Email" name="email" />
              </div>
              <div class="mb-3">
                <vsud-input id="password" type="password" placeholder="Password" name="password" />
              </div>
...
// onMounted(() => {
basic.hideConfigButton = true
basic.showSidenav = false
basic.showNavbar = false
basic.showFooter = false
// })
