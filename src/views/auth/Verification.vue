          ...
          <div class="col-lg-4 col-md-7">
            <div class="card">
              <div class="text-center card-body px-lg-5 py-lg-5">
                <div class="mb-4 info">
                  <div class="py-3 mx-auto text-center shadow icon icon-shape icon-xl rounded-circle bg-gradient-warning">
                ...
                <div class="row gx-2 gx-sm-3">
                  <div class="col">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg" maxlength="1" autocomplete="off"
                        autocapitalize="off" />
                    </div>
                  </div>
                  <div class="col">
                ...
                <div class="text-center">
                  <vsud-button class="mt-0 mb-3" variant="gradient" color="warning" full-width>Send code</vsud-button>
