<template>
  ...
  <div id="password" class="card mt-4">
    ...
    <div class="card-body pt-0">
      ...
      <vsud-button class="float-end mt-6 mb-0" color="dark" variant="gradient" size="sm">Update password</vsud-button>
    </div>
  </div>
  ...
  <div id="accounts" class="card mt-4">
    ...
    <div class="card-body pt-0">
      <div class="d-flex">
        <vsud-avatar class="width-48-px" :img="img1" alt="logo_slack" />
      ...
      <div class="ps-5 pt-3 ms-3">
        <p class="mb-0 text-sm">
          You haven't added your Slack yet or you aren't authorized. Please add our Slack Bot to your account by clicking
          on
          <a href="javascript">here</a>. When you've added the bot, send your verification code that you have received.
        </p>
        ...
        <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
          ...
          <vsud-button color="danger" variant="gradient" size="sm" class="my-sm-auto mt-2 mb-0" type="button"
            name="button">Delete</vsud-button>
        </div>
      </div>
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vsud-avatar class="width-48-px" :img="img2" alt="logo_spotify" />
        <div class="my-auto ms-3">
          <div class="h-100">
      ...
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vsud-avatar class="width-48-px" :img="img3" alt="logo_atlassian" />
        <div class="my-auto ms-3">
          <div class="h-100">
      ...
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vsud-avatar class="width-48-px" :img="img4" alt="logo_asana" />
        <div class="my-auto ms-3">
          <div class="h-100">
  ...
  <div id="notifications" class="card mt-4">
    <div class="card-header">
      <h5>Notifications</h5>
      <p class="text-sm">Choose how you receive notifications. These notification settings apply to the things you’re
        watching.</p>
    </div>
    <div class="card-body pt-0">
  ...
  <div id="sessions" class="card mt-4">
    <div class="card-header pb-3">
      <h5>Sessions</h5>
      <p class="text-sm">This is a list of devices that have logged into your account. Remove those that you do not
        recognize.</p>
    </div>
    <div class="card-body pt-0">
  ...
  <div id="delete" class="card mt-4">
    ...
    <div class="card-body d-sm-flex pt-0">
      ...
      <vsud-button color="secondary" variant="outline" class="mb-0 ms-auto" type="button"
        name="button">Deactivate</vsud-button>
      <vsud-button color="danger" variant="gradient" class="mb-0 ms-2" type="button" name="button">Delete
        Account</vsud-button>
    </div>
  </div>
</template>
