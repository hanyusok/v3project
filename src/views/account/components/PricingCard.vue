  ...
  <div class="card">
    ...
    <div class="pt-0 text-center card-body text-lg-start">
      <div class="p-2 d-flex justify-content-lg-start justify-content-center">
        <div class="text-center shadow icon icon-shape icon-xs rounded-circle bg-gradient-success">
      ...
      <div class="p-2 d-flex justify-content-lg-start justify-content-center">
        <div class="text-center shadow icon icon-shape icon-xs rounded-circle"
          ...
          <i class="fas" :class="intHelp ? 'fa-check opacity-10' : 'fa-minus'"></i>
        </div>
        <div>
      ...
      <div class="p-2 d-flex justify-content-lg-start justify-content-center">
        <div class="text-center shadow icon icon-shape icon-xs rounded-circle"
          ...
          <i class="fas" :class="skFiles ? 'fa-check opacity-10' : 'fa-minus'"></i>
        </div>
        <div>
      ...
      <div class="p-2 d-flex justify-content-lg-start justify-content-center">
        <div class="text-center shadow icon icon-shape icon-xs rounded-circle"
          ...
          <i class="fas" :class="apiAccess ? 'fa-check opacity-10' : 'fa-minus'"></i>
        </div>
        <div>
      ...
      <div class="p-2 d-flex justify-content-lg-start justify-content-center">
        <div class="text-center shadow icon icon-shape icon-xs rounded-circle"
          ...
          <i class="fas" :class="comDocument ? 'fa-check opacity-10' : 'fa-minus'"></i>
        </div>
        <div>
          <span class="ps-3">Complete documentation </span>
        </div>
      </div>
      <a href="javascript:;" class="mt-3 mb-0 btn btn-icon d-lg-block"
