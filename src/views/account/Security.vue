  ...
  <div class="container-fluid mt-4">
    ...
    <div class="row mt-4">
      <div class="col-sm-6">
        ...
        <select id="choices-questions" ref="choicesQuestions" class="form-control" name="choices-questions">
          ...
          <div class="card-body p-3">
            ...
            <div class="row mt-5">
              <div class="col-lg-8 col-12 actions text-end ms-auto">
                <vsud-button color="success" variant="outline" size="sm" class="btn-sm mb-0 me-1"
                  type="reset">Cancel</vsud-button>
                <vsud-button color="success" variant="gradient" size="sm" class="btn-sm mb-0" type="button">Save
                  Changes</vsud-button>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-6 pb-3">
        <div class="card">
          ...
          <div class="card-body p-3">
            ...
            <vsud-button color="dark" variant="gradient" full-width class="w-100 mb-0">Update password</vsud-button>
          </div>
        </div>
      </div>
      <div class="col-md-6">
...
export default {
  ...
  mounted() {
    new Choices(this.$refs.choicesQuestions, { allowHTML: true })
  },
};
</script>
