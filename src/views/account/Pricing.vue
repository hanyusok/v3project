        ...
        <div class="mx-auto text-center col-lg-4 col-md-6 col-7">
          <div class="mt-5 nav-wrapper position-relative z-index-2">
            <ul id="tabs-pricing" class="flex-row p-1 nav nav-pills nav-fill" role="tablist">
              <li class="nav-item">
                <a id="tabs-iconpricing-tab-1" class="mb-0 nav-link active" data-bs-toggle="tab" href="#monthly"
                  role="tab" aria-controls="monthly" aria-selected="true">Monthly</a>
              </li>
              <li class="nav-item">
                <a id="tabs-iconpricing-tab-2" class="mb-0 nav-link" data-bs-toggle="tab" href="#annual" role="tab"
                  aria-controls="annual" aria-selected="false">Annual</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="tab-content tab-space">
        <div id="monthly" class="tab-pane active">
          <div class="row">
            ...
            <div class="mb-4 col-lg-4 mb-lg-0">
              <pricing-card m-package="Premium" value="89" num-of-members="10" storage="40" int-help sk-files premium />
            </div>
            <div class="mb-4 col-lg-4 mb-lg-0">
              <pricing-card m-package="Enterprise" value="99" num-of-members="Unlimited" storage="100" int-help sk-files
                api-access com-document />
            </div>
          </div>
        </div>
        <div id="annual" class="tab-pane">
          <div class="row">
            ...
            <div class="mb-4 col-lg-4 mb-lg-0">
              <pricing-card m-package="Premium" value="159" num-of-members="10" storage="40" int-help sk-files premium />
            </div>
            <div class="mb-4 col-lg-4 mb-lg-0">
              <pricing-card m-package="Enterprise" value="399" num-of-members="Unlimited" storage="100" int-help sk-files
                api-access com-document />
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    this.basic.showSidenav = false
    this.basic.showNavbar = false;
    this.basic.showFooter = false;
    setNavPills();
  },
  beforeUnmount() {
    this.basic.showSidenav = true;
    this.basic.showNavbar = true;
    this.basic.showFooter = true;
    if (this.basic.isPinned === false) {
      const sidenav_show = document.querySelector(".g-sidenav-show");
      sidenav_show.classList.remove("g-sidenav-hidden");
      sidenav_show.classList.add("g-sidenav-pinned");
      this.basic.isPinned = true;
    }
  },
};
</script>
