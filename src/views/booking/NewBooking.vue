    ...
    <div class="row">
      <div class="mx-auto col-lg-9 col-12">
        <div class="mt-4 card card-body">
          ...
          <p class="mb-0 text-sm">Create new booking</p>
          <hr class="my-3 horizontal dark" />
          <label for="projectName" class="form-label">Booking Name</label>
          <input id="projectName" type="text" class="form-control" />
          <div class="mt-4 row">
            <div class="col-12 col-md-6">
              <div class="form-group">
                <label> Private Booking </label>
                ...
                <div class="form-check form-switch ms-1">
                  <input id="flexSwitchCheckDefault" class="form-check-input" type="checkbox" onclick="notify(this)"
                    data-type="warning"
          ...
          <label class="mt-4">Booking Description</label>
          <p class="text-xs form-text text-muted ms-1">
          ...
          <select id="choices-multiple-remove-button" class="form-control" name="choices-multiple-remove-button" multiple>
