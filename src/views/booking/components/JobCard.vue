  ...
  <div class="card">
    ...
    <div class="p-3 pt-1 card-body">
      ...
      <div class="p-3 bg-gray-100 d-flex border-radius-lg">
        <h4 class="my-auto">
          <span class="text-sm text-secondary me-1">$</span>3,000<span class="text-sm text-secondary ms-1">/ month
          </span>
        </h4>
        <a href="javascript:;" class="mb-0 btn btn-outline-dark ms-auto">Apply</a>
      </div>
    </div>
  </div>
</template>
