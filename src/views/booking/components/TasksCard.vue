  ...
  <div class="overflow-hidden card">
    <div class="p-3 pb-0 card-header">
      <div class="d-flex align-items-center">
        <div class="text-center shadow icon icon-shape border-radius-md" :class="bgColor">
          <i class="text-lg ni ni-calendar-grid-58 opacity-10" aria-hidden="true"></i>
        </div>
        <div :class="basic.isRTL ? 'me-3' : 'ms-3'">
          <p class="mb-0 text-sm text-capitalize font-weight-bold">
            {{ title }}
          </p>
          <h5 class="mb-0 font-weight-bolder">480</h5>
        </div>
        <div class="progress-wrapper w-25" :class="basic.isRTL ? 'me-auto' : 'ms-auto'">
          ...
          <div class="progress">
            <div class="progress-bar w-60" :class="bgColor" role="progressbar" aria-valuenow="60" aria-valuemin="0"
