            ...
            <div class="mx-auto mt-4 mb-3 col-12 col-lg-8 mb-sm-5">
              <div class="multisteps-form__progress">
                <button class="multisteps-form__progress-btn js-active" type="button" title="Product Info"
                  ...
                  <span>1. Clinic Info</span>
                </button>
                <button class="multisteps-form__progress-btn" type="button" title="Media"
                  :class="activeStep >= 1 ? activeClass : ''" @click="activeStep = 1">2. Media</button>
          ...
          <div class="row">
            <div class="m-auto col-12 col-lg-8">
              <form class="mb-8 multisteps-form__form">
                <!--single form panel-->
                <clinic-info :class="activeStep === 0 ? activeClass : ''" />
                <!--single form panel-->
...
export default {
  ...
  mounted() {
    ...
    this.basic.isAbsolute = true
    setNavPills();
  },
  beforeUnmount() {
    // this.$store.state.isAbsolute = false;
    this.basic.isAbsolute = false
  },
  methods: {
    nextStep() {
