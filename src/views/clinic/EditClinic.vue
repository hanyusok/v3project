  ...
  <div class="py-4 container-fluid">
    <div class="row">
      ...
      <div class="text-right col-lg-6 d-flex flex-column justify-content-center">
        <button type="button" class="mt-2 mb-0  btn bg-gradient-success ms-lg-auto me-lg-0 me-auto mt-lg-0">
          Save
        </button>
      </div>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <label>Color</label>
                <select id="choices-color-edit" class="form-control" name="choices-color">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-4">
                ...
                <select id="choices-currency-edit" class="form-control" name="choices-sizes">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <select id="choices-tags-edit" class="form-control" name="choices-tags" multiple>
