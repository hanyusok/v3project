  ...
  <div class="py-4 container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h5 class="mb-4">Clinic Details</h5>
            <div class="row">
              <div class="text-center col-xl-5 col-lg-6">
                <img class="mx-auto shadow-lg w-100 border-radius-lg"
                  ...
                  alt="chair" />
                <div class="pt-2 mt-4 my-gallery d-flex" itemscope itemtype="http://schema.org/ImageGallery">
                  <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                    <a href="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/ecommerce/chair-pink.jpg"
                      ...
                      <img class="shadow w-75 min-height-100 max-height-100 border-radius-lg"
              ...
              <div class="mx-auto col-lg-5">
                ...
                <div class="mt-4 row">
                  <div class="mt-2 col-lg-5 mt-lg-0">
                    ...
                    <select id="choices-material" class="form-control" name="choices-material">
                  ...
                  <div class="mt-2 col-lg-5 mt-lg-0">
                    <label>Color</label>
                    <select id="choices-colors" class="form-control" name="choices-colors">
                  ...
                  <div class="col-lg-2">
                    ...
                    <select id="choices-quantity" class="form-control" name="choices-quantity">
                ...
                <div class="mt-4 row">
                  <div class="col-lg-5">
                    <button class="mb-0 btn bg-gradient-success mt-lg-auto w-100" type="button" name="button">
                      Add to cart
                    </button>
                  </div>
                </div>
...
import OtherProducts from "./components/OtherClinics.vue";
