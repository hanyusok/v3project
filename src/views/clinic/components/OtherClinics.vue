<template>
  <div class="col-12">
    <h5 class="ms-3">Other Clinics</h5>
      ...
      <table class="table mb-0 align-items-center">
        ...
        <tbody>
          <tr>
            ...
            <td class="text-sm align-middle">
              <div class="mx-auto progress">
                <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 80%" aria-valuenow="80"
          ...
          <tr>
            ...
            <td class="text-sm align-middle">
              <div class="mx-auto progress">
                <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 90%" aria-valuenow="90"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </td>
            <td class="text-center align-middle">
          ...
          <tr>
            ...
            <td class="text-sm align-middle">
              <div class="mx-auto progress">
                <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: 60%" aria-valuenow="60"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </td>
            <td class="text-center align-middle">
          ...
          <tr>
            ...
            <td class="text-sm align-middle">
              <div class="mx-auto progress">
                <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: 40%" aria-valuenow="40"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </td>
            <td class="text-center align-middle">
